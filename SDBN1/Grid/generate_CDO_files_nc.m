...
%% write 2D and 1d x,y
wnc(xcenters-proj_info.falseeasting,grid.xyOutputFileName,'x2','m','grid center x-coordinate',{'x1','y1'},0,'classic')
wnc(ycenters-proj_info.falsenorthing,grid.xyOutputFileName,'y2','m','grid center y-coordinate',{'x1','y1'},0,'classic')

wnc(squeeze(xcenters(:,1))-proj_info.falseeasting,grid.xyOutputFileName,'x1','m','grid center x-coordinate','x1',0,'classic')
wnc(squeeze(ycenters(1,:))-proj_info.falsenorthing,grid.xyOutputFileName,'y1','m','grid center y-coordinate','y1',0,'classic')
